...
const news = [
  {
    ...
    title: "5 Proven Study Techniques to Boost Your Academic Performance",
    excerpt: "Discover the most effective study methods used by top students worldwide. From spaced repetition to the Pomodoro technique, these strategies will transform the way you learn.",
    author: "Admin",
    date: "March 10, 2025",
    readTime: "5 min read",
    featured: true,
  },
  {
    ...
    title: "StudyHub Now Offers 1-on-1 Sessions in Over 50 Subjects",
    excerpt: "We're excited to announce the expansion of our tutor network. Students can now find expert tutors in more subjects than ever before.",
    author: "Admin",
    date: "March 8, 2025",
    readTime: "3 min read",
    featured: false,
  },
  {
    ...
    title: "How Sarah Improved Her Math Grade from D to A in Just 3 Months",
    excerpt: "Read Sarah's incredible journey of academic transformation with the help of her dedicated StudyHub tutor.",
    author: "Admin",
    date: "March 5, 2025",
    readTime: "6 min read",
    featured: false,
  },
  {
    ...
    excerpt: "Not all tutors teach the same way, and not all students learn the same way. Here's a comprehensive guide to matching yourself with the perfect tutor.",
    author: "Admin",
    date: "March 3, 2025",
    readTime: "4 min read",
    featured: false,
  },
  {
    ...
    category: "Platform News",
    categoryColor: "bg-blue-100 text-blue-600",
    title: "Introducing the New Interactive Whiteboard 2.0 Feature",
    excerpt: "Our upgraded whiteboard now supports multi-user drawing, LaTeX equations, code highlighting, and real-time collaboration tools.",
    author: "Admin",
    date: "Feb 28, 2025",
    readTime: "3 min read",
    featured: false,
  },
  {
    ...
    excerpt: "AI-powered tutoring, VR classrooms, and personalized learning paths are reshaping education.",
    author: "Admin",
    date: "Feb 25, 2025",
    readTime: "7 min read",
    featured: false,
...
const iconPaths = {
  "Tips & Tricks": "M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z",
  "Platform News": "M11 5.882V19.24a1.76 1.76 0 01-3.417.592l-2.147-6.15M18 13a3 3 0 100-6M5.436 13.683A4.001 4.001 0 017 6h1.832c4.1 0 7.625-1.234 9.168-3v14c-1.543-1.766-5.067-3-9.168-3H7a3.988 3.988 0 01-1.564-.317z",
...
const cardBg = { "Tips & Tricks": "bg-orange-50", "Platform News": "bg-blue-50", "Student Success": "bg-green-50", "Education": "bg-purple-50" };
const iconBg = { "Tips & Tricks": "bg-orange-400", "Platform News": "bg-blue-400", "Student Success": "bg-green-400", "Education": "bg-purple-400" };

const categories = ["All", "Tips & Tricks", "Platform News", "Student Success", "Education"];
  ...
  return (
    <div className="bg-gradient-to-br from-blue-600 to-blue-800 rounded-3xl p-8 md:p-10 text-white flex flex-col md:flex-row gap-8 items-center shadow-xl shadow-blue-200">
      ...
      <div className="flex-1">
        <span className="inline-block bg-orange-500 text-white text-xs font-bold px-3 py-1 rounded-full mb-4">⭐ Featured</span>
      ...
      <div className={`${cardBg[post.category] || "bg-gray-50"} h-44 flex items-center justify-center`}>
        <div className={`w-14 h-14 ${iconBg[post.category] || "bg-gray-400"} rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform shadow-md`}>
          <svg className="w-7 h-7 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d={iconPaths[post.category] || iconPaths["Education"]} />
          </svg>
        </div>
      </div>
      <div className="p-6">
  ...
  return (
    <div className="min-h-screen font-sans">
      ...
      <PageHeader
        tag="StudyHub Blog"
        title="News & Updates"
        description="Stay up to date with the latest tips, platform news, and student success stories."
      />
