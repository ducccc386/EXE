function Squiggly({ color = "#3B82F6", className = "" }) {
  return (
    <svg viewBox="0 0 80 20" fill="none" className={className}>
      <path d="M2 10 C10 2, 18 18, 26 10 C34 2, 42 18, 50 10 C58 2, 66 18, 74 10"
      ...
      <div className="max-w-7xl mx-auto px-6 py-16 md:py-24 flex flex-col md:flex-row items-center gap-12 relative z-10">
        ...
        <div className="flex-1 max-w-xl">
          ...
          <p className="text-gray-500 text-lg leading-relaxed mb-8 mt-6">
            ...
            <br />
            It is completely <span className="text-orange-500 font-semibold">free</span> &amp; <span className="text-blue-600 font-semibold">private</span>.
          </p>

          <div className="flex flex-wrap items-center gap-4">
            <a
              href="#"
              className="bg-orange-500 hover:bg-orange-600 text-white font-bold px-7 py-3.5 rounded-full transition-all hover:shadow-xl hover:shadow-orange-200 active:scale-95 text-sm"
            >
              Get Started
            </a>
        ...
        <div className="flex-1 relative flex justify-center">
            ...
            <div className="bg-blue-50 rounded-3xl overflow-hidden h-52 w-44 flex items-end justify-center shadow-md hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
              <div className="w-full h-full bg-gradient-to-br from-blue-100 to-blue-200 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <span className="text-xs font-semibold text-blue-700">Math Tutor</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-orange-50 rounded-3xl overflow-hidden h-52 w-44 mt-6 flex items-end justify-center shadow-md hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
              <div className="w-full h-full bg-gradient-to-br from-orange-100 to-orange-200 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <span className="text-xs font-semibold text-orange-700">Science Expert</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-green-50 rounded-3xl overflow-hidden h-52 w-44 -mt-4 flex items-end justify-center shadow-md hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
              <div className="w-full h-full bg-gradient-to-br from-green-100 to-emerald-200 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <span className="text-xs font-semibold text-emerald-700">Language Pro</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-purple-50 rounded-3xl overflow-hidden h-52 w-44 flex items-end justify-center shadow-md hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
              <div className="w-full h-full bg-gradient-to-br from-purple-100 to-purple-200 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <span className="text-xs font-semibold text-purple-700">Code Mentor</span>
                </div>
              </div>
            </div>
          </div>
          ...
          {/* Floating badge */}
          <div className="absolute -bottom-10 left-0 bg-white rounded-2xl shadow-xl px-4 py-3 flex items-center gap-3 border border-gray-100">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500">4.9/5 from students</p>
            </div>
          </div>
        </div>
      </div>
