 ...
 * Decorative SVG shapes và PageHeader dùng chung cho các trang.
 */
  ...
  return (
    <section className="bg-gradient-to-b from-blue-50 to-white py-14 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 text-center relative z-10">
        {tag && <span className="text-orange-500 text-xs font-bold uppercase tracking-widest mb-3 block">{tag}</span>}
        <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 mb-4">{title}</h1>
        {description && <p className="text-gray-500 text-lg max-w-xl mx-auto">{description}</p>}
      </div>
    </section>
  );
}
