  ...
  return (
    <>
      <div className="bg-amber-400 text-center py-2 px-4 text-sm font-medium text-gray-800">
        Bạn là sinh viên đại học hoặc học sinh và muốn hợp tác gia sư trực
        tuyến?{" "}
        <a
          href="#"
          ...
          <div className="md:hidden border-t border-gray-100 px-6 py-4 space-y-3 bg-white">
            {navLinks.map((item) => (
              <Link
                key={item.to}
                to={item.to}
                className={`block text-sm font-medium transition-colors py-1 ${pathname === item.to
                  ? "text-orange-500"
            ...
            <div className="flex gap-3 pt-2">
              <a
                href="#"
                className="flex-1 text-center text-sm font-semibold text-gray-700 border border-gray-200 py-2 rounded-full hover:border-blue-400 transition-colors"
              >
                Đăng nhập
              </a>
              <a
                href="#"
                className="flex-1 text-center bg-blue-600 text-white text-sm font-semibold py-2 rounded-full hover:bg-blue-700 transition-colors"
              >
                Đăng ký
              </a>
            </div>
