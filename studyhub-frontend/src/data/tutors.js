...
export const tutors = [
  ...
  },
  {
    ...
    subject: "Tiếng Anh",
    subjectColor: "text-blue-600 bg-blue-50",
    title: "IELTS 8.0 – Cử nhân Ngôn ngữ Anh",
    rating: 4.9,
    reviewCount: 76,
    pricePerHour: 280000,
    totalSessions: 184,
    verified: true,
    tags: ["English", "IELTS", "Speaking", "Grammar"],
    bio: "Chuyên luyện giao tiếp, IELTS và ngữ pháp thực hành với lộ trình rõ ràng, dễ theo dõi.",
    availability: "Buổi tối và cuối tuần",
  },
  {
    id: 8,
    name: "Lê Thảo Vy",
    ...
    subject: "Văn học",
    subjectColor: "text-orange-600 bg-orange-50",
    title: "Cử nhân Sư phạm Ngữ văn – ĐH Sư phạm TP.HCM",
    rating: 4.8,
    reviewCount: 58,
    pricePerHour: 220000,
    totalSessions: 137,
    verified: true,
    tags: ["Literature", "Essay", "Reading", "Writing"],
    bio: "Dạy phân tích tác phẩm, luyện viết và kỹ năng làm bài nghị luận với ví dụ dễ hiểu.",
  ...
  },
  {
    ...
    subject: "Toán học",
    subjectColor: "text-green-600 bg-green-50",
    title: "SAT Math & Algebra – 6 năm kinh nghiệm",
    rating: 4.7,
    reviewCount: 49,
    pricePerHour: 260000,
    totalSessions: 121,
    verified: true,
    tags: ["Math", "SAT", "Algebra", "Problem Solving"],
    bio: "Tập trung luyện SAT Math, tư duy logic và chiến lược làm bài tốc độ cao.",
    availability: "Linh hoạt theo lịch",
  },
];
